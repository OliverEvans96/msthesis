...
The computational crux of calculating the kelp distribution is to integrate $P_{2D}(\theta_f, l)$ from \eqref{eq:p2d} over the occupancy region $R_s(\theta, s)$, defined by \eqref{eqn:rs_th} and \eqref{eqn:rs_l}, for every point $(\theta,s)$ in the $xy$--domain.
