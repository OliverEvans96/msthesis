...
\begin{figure}[H]
  \centering
  \includegraphics[width=6in]{memory_solve}
...
From the other perspective, consider an overall discretization error criterion of $\bar{\varepsilon}=\SI{2e-2}{\W\per\m\squared}$.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=5.75in]{gs_predicted_err}
...
The clear pattern in the variation of error over the $a_w \nbd b$ domain indicates that a third parameter can be calculated from $a_w$ and $b$, which is sufficient to determine the accuracy of the approximation.

\begin{figure}[h]
  \centering
  \includegraphics[width=4.75in]{asym_err_vs_ab}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=4.75in]{best_n_data_vs_ab}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=5.75in]{asym_err_data_xi_model}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=5.5in]{asym_err_vs_xi_all_n_fit_all}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=5.75in]{nbar_model_vs_ab_3eps}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=5.75in]{compare_models_haoce11_both}
