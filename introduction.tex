...
In terms of optical quantities, of primary interest is the radiance at each point in all directions, which affects the photosynthetic rate of the kelp, and therefore the total amount of biomass producible in a given area as well as the total nutrient remediation potential.
...
The radiative transfer equation has been used extensively in stellar astrophysics \cite{chandrasekhar_radiative_1960,petkova_novel_2011}; its application to marine biology is fairly recent \cite{mobley_radiative_2001}.
...
For those which are not readily available, rough estimates are given or experimental methods for their determination are described.
...
Finally, Chapter \ref{chap:conclusion} concludes the thesis by giving a brief summary of the model, discusses and its performance, and suggests improvements and avenues for future work.
