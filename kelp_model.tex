...
Give both explanations: moving rope and convenient solution to numerical dilemma.

\section{Kelp Distribution Visualization}
% TODO: Add a few plots demonstrating that model does what I say it does

\pagebreak
\begin{figure}[H]
  \centering
  \includegraphics[width=5in]{kelp_dist_sharp}
  \caption{kelp dist sharp}
...
\begin{figure}[H]
  ...
  \caption{kelp dist smooth smallblur}
